	...
	return (
		<>
			...
			<div className="flex justify-between relative top-3 hidden lg:flex">
				<div>
					<img src="/LogoUnikom.ico" className="w-12 h-12 rounded-full" alt="" />
				</div>
				<ul className="mt-2 flex gap-5">
					...
					<li className="mb-4">
						<a href="#Tugas" className="text-white opacity-80 text-[1rem] font-semibold">
							Tugas
						</a>
					</li>
					<li>
						<a href="#Tabs" className="text-white opacity-80 text-[1rem] font-semibold">
							Structure  Schedule & Tugas
						</a>
					</li>
				</ul>
			</div>
